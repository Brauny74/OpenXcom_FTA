 ...
 */
IntelCompleteState::IntelCompleteState(IntelProject *project, Base *base) : _project(project), _base(base)
{
	_screen = false;
	...
	add(_txtResearch, "text2", "geoIntelComplete");
	...
	if (project)
	{
		_txtResearch->setText(tr(project->getName()));
	}
}
